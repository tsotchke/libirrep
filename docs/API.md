...
6. **Wilson-loop spectrum**: `irrep_magnon_wilson_spectrum(L, kx, Ny,
   ...
   kagome (-1, 0, +1) model.
7. **Free energy F(T)**: `irrep_magnon_free_energy(L, T, Nx, Ny)`
