...
IRREP_API void irrep_rbf_bessel_d_batch(int n, size_t N, const double *r, double r_cut,
                                        double *out);
...
IRREP_API void irrep_rbf_gaussian_grid(int n, double *out, double r, double r_min, double r_max,
                                       double sigma);
 ...
 *  @{ */
IRREP_API void irrep_rbf_bessel_batch(int n, size_t N, const double *r, double r_cut, double *out);
IRREP_API void irrep_cutoff_cosine_batch(size_t N, const double *r, double r_cut, double *out);
IRREP_API void irrep_cutoff_polynomial_batch(size_t N, const double *r, double r_cut, int p,
                                             double *out);
IRREP_API void irrep_cutoff_cosine_d_batch(size_t N, const double *r, double r_cut, double *out);
IRREP_API void irrep_cutoff_polynomial_d_batch(size_t N, const double *r, double r_cut, int p,
                                               double *out);
/** @} */
