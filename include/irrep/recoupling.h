...
IRREP_API double irrep_wigner_6j(int j1, int j2, int j3, int j4, int j5, int j6);
/** @brief Doubled-integer variant (half-spin). */
IRREP_API double irrep_wigner_6j_2j(int two_j1, int two_j2, int two_j3, int two_j4, int two_j5,
                                    int two_j6);

/** @brief Wigner 9j symbol `{j1 j2 j3; j4 j5 j6; j7 j8 j9}`. */
IRREP_API double irrep_wigner_9j(int j1, int j2, int j3, int j4, int j5, int j6, int j7, int j8,
                                 int j9);
/** @brief Doubled-integer variant. */
IRREP_API double irrep_wigner_9j_2j(int two_j1, int two_j2, int two_j3, int two_j4, int two_j5,
