...
IRREP_API tp_descriptor_t *irrep_tp_build(const irrep_multiset_t *a, const irrep_multiset_t *b,
...
IRREP_API int irrep_tp_enumerate_paths(const irrep_multiset_t *a, const irrep_multiset_t *b,
                                       const irrep_multiset_t *c, int *out_paths, int max_paths);

/** @brief Forward: `c = a ⊗ b` with unit weights per path. */
IRREP_API void irrep_tp_apply(const tp_descriptor_t *desc, const double *a_in, const double *b_in,
                              double *c_out);

/** @brief Forward with one learnable scalar weight per selected path. */
IRREP_API void irrep_tp_apply_weighted(const tp_descriptor_t *desc, const double *weights,
                                       const double *a_in, const double *b_in, double *c_out);

/** @brief Unweighted backward. Accumulates into @p grad_a, @p grad_b (caller
 *         zero-initialises). */
IRREP_API void irrep_tp_apply_backward(const tp_descriptor_t *desc, const double *a_in,
...
IRREP_API void irrep_tp_apply_backward_weighted(const tp_descriptor_t *desc, const double *weights,
                                                const double *a_in, const double *b_in,
                                                const double *grad_c_out, double *grad_a,
                                                double *grad_b, double *grad_w);
 ...
 *  @{ */
IRREP_API void irrep_tp_apply_batch(const tp_descriptor_t *desc, size_t batch, const double *a_in,
                                    const double *b_in, double *c_out);
IRREP_API void irrep_tp_apply_weighted_batch(const tp_descriptor_t *desc, size_t batch,
                                             const double *weights, const double *a_in,
                                             const double *b_in, double *c_out);
IRREP_API void irrep_tp_apply_backward_batch(const tp_descriptor_t *desc, size_t batch,
                                             const double *a_in, const double *b_in,
                                             const double *grad_c_out, double *grad_a,
                                             double *grad_b);
IRREP_API void irrep_tp_apply_backward_weighted_batch(const tp_descriptor_t *desc, size_t batch,
                                                      const double *weights, const double *a_in,
...
IRREP_API int irrep_tp_2j_enumerate_paths(const irrep_multiset_2j_t *a,
                                          ...
                                          const irrep_multiset_2j_t *c, int *out_paths,
                                          int max_paths);
...
IRREP_API tp_2j_descriptor_t *irrep_tp_2j_build(const irrep_multiset_2j_t *a,
                                                const irrep_multiset_2j_t *b,
...
IRREP_API void irrep_tp_2j_apply(const tp_2j_descriptor_t *desc, const double _Complex *a_in,
...
IRREP_API void irrep_tp_2j_apply_backward(const tp_2j_descriptor_t *desc,
                                          ...
                                          double _Complex *grad_a, double _Complex *grad_b,
...
IRREP_API tp_descriptor_t *irrep_tp_build_uvw(const irrep_multiset_t *a, const irrep_multiset_t *b,
                                              const irrep_multiset_t *c, const int *selected_paths,
                                              int num_selected_paths);
...
IRREP_API void irrep_tp_apply_uvw(const tp_descriptor_t *desc, const double *weights,
                                  const double *a_in, const double *b_in, double *c_out);

/** @brief UVW backward. Accumulates gradients into @p grad_a, @p grad_b, @p grad_w. */
IRREP_API void irrep_tp_apply_uvw_backward(const tp_descriptor_t *desc, const double *weights,
                                           const double *a_in, const double *b_in,
...
IRREP_API void irrep_tp_weight_l2_per_path_uvw(const tp_descriptor_t *desc, const double *weights,
                                               double *out);
...
IRREP_API void irrep_tp_weight_l2_per_path_uvw_backward(const tp_descriptor_t *desc,
