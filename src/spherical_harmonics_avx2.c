...
static void sh_cart_all_quad_(int l_max,
                              const double *rhat_0, const double *rhat_1,
                              const double *rhat_2, const double *rhat_3,
                              double *out_0, double *out_1,
                              double *out_2, double *out_3) {
    ...
    for (int l = 0; l <= l_max; ++l) {
        ...
        for (int m = 1; m <= l; ++m) {
            ...
            const __m256d vP = _mm256_setr_pd(P0[l * stride + m],
                                              P1[l * stride + m],
                                              P2[l * stride + m],
                                              P3[l * stride + m]);
