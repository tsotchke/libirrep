...
static void sh_cart_all_pair_(int l_max, const double *rhat_a, const double *rhat_b, double *out_a,
                              double *out_b) {
...
void irrep_sph_harm_cart_all_batch_neon(int l_max, size_t N, const double *r_hats, double *out) {
    ...
    size_t    e = 0;
    for (; e + 2 <= N; e += 2) {
        sh_cart_all_pair_(l_max, r_hats + e * 3, r_hats + (e + 1) * 3, out + e * (size_t)block,
