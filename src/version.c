...
int         irrep_version_major (void) { return IRREP_VERSION_MAJOR; }
int         irrep_version_minor (void) { return IRREP_VERSION_MINOR; }
int         irrep_version_patch (void) { return IRREP_VERSION_PATCH; }
const char *irrep_version_string(void) { return IRREP_VERSION_STRING; }
