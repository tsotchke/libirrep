...
int main(void) {
    ...
    /* ---- compose(R, R^-1) = I ---- */
    {
        irrep_rot_matrix_t R =
            irrep_rot_from_axis_angle((irrep_axis_angle_t){{0.5, -0.2, 0.8}, 1.1});
    ...
    /* ---- geodesic distance: from I to R(θ) equals θ ---- */
    {
        double             theta = 1.2345;
        irrep_rot_matrix_t R =
            irrep_rot_from_axis_angle((irrep_axis_angle_t){{0.0, 1.0, 0.0}, theta});
    ...
    {
        irrep_quaternion_t q0 = irrep_quat_from_axis_angle((irrep_axis_angle_t){{0, 0, 1}, 0.2});
        irrep_quaternion_t q1 = irrep_quat_from_axis_angle((irrep_axis_angle_t){{0, 0, 1}, 1.2});
