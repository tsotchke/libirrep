...
int main(void) {
    ...
    /* ---- SU(2) ↔ quaternion round trip ---- */
    {
        irrep_quaternion_t q =
            irrep_quat_from_axis_angle((irrep_axis_angle_t){{0.3, -0.6, 0.2}, 0.9});
    ...
    {
        irrep_quaternion_t q1 = irrep_quat_from_axis_angle((irrep_axis_angle_t){{1, 0, 0}, 0.7});
    ...
    {
        irrep_quaternion_t q =
            irrep_quat_from_axis_angle((irrep_axis_angle_t){{0, 0, 1}, 2.0 * M_PI});
        irrep_su2_t U = irrep_su2_from_quat(q);
    ...
    {
        irrep_quaternion_t q =
            irrep_quat_from_axis_angle((irrep_axis_angle_t){{0.1, 0.9, -0.3}, 1.4});
        irrep_su2_t U = irrep_su2_from_quat(q);
